...
export default async function BlogPostPage({ params }: BlogPostPageProps) {
  ...
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://resume-matcher.com';
  ...
  const breadcrumbData = BlogSEOGenerator.generateBreadcrumbStructuredData([
    {
  ...
  return (
    <>
      ...
      <StructuredDataComponent data={breadcrumbData} />
